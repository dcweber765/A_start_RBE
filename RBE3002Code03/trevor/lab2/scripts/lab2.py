...
class Robot:
    ...
    def rotate(self, angle):
        ...
        # twoPi = 6.28
        # speed = 0.1
        # startYaw = self.adjYaw
        # yaw = startYaw
        # endAngle = round((yaw + angle) % (2 * math.pi), 2)
        # if endAngle == 0:
        #     endAngle = twoPi

        # if endAngle - yaw >= 0:
        #     while endAngle - yaw >= 0 and yaw > (endAngle - twoPi):
        #         if abs(endAngle - yaw) < .2:
        #             speed = .05
        #         twist = Twist()
        #         twist.linear.x = 0.0; twist.linear.y = 0.0; twist.linear.z = 0.0
        #         twist.angular.x = 0.0; twist.angular.y = 0.0; twist.angular.z = speed
        #         self.pub.publish(twist)
        ...
        #         twist = Twist()
        #         twist.linear.x = 0.0; twist.linear.y = 0.0; twist.linear.z = 0.0
        #         twist.angular.x = 0.0; twist.angular.y = 0.0; twist.angular.z = -1*speed
        #         self.pub.publish(twist)
