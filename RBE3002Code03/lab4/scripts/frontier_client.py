...
class frontier_client:
    ...
    def frontier_client_star(self):
        ...
        if self.finalGoal != None:
            self.finalGoal.header.frame_id = "final"
            self.finalGoal.pose.position.x = self.finalGoal.pose.position.x #- self.xOffset
            self.finalGoal.pose.position.y = self.finalGoal.pose.position.y #- self.yOffset
            self.goal = self.finalGoal
    ...
    def goalCallback(self, data):
        ...
        """
        self.finalGoal = data
        print "finalGoal:", self.finalGoal
