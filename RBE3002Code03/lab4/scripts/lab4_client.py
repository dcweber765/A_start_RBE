...
# Script for robot rotation and driving straight
from lab2 import *
...
class lab4_client:
    ...
    def __init__(self):
        ...
        # Initialize Node
        rospy.init_node('lab4_client', anonymous=True)  # create a unique node name
